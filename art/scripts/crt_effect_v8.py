"""
CRT v8 -- the bloom must come from WITHIN the tube.
...
def apply_crt_v6(portrait_path, output_path, size=(400, 400)):
    ...
    bloom = b1 * 0.55 + b2 * 0.45 + b3 * 0.28 + b4 * 0.18  # wider, softer halo
...
apply_crt_v6("/tmp/aether-art/austin-portrait-square.jpg",
             "/tmp/aether-art/crt_portrait_v8_large.png", size=(400, 400))
apply_crt_v6("/tmp/aether-art/austin-portrait-square.jpg",
             "/tmp/aether-art/crt_portrait_v8.png", size=(175, 175))
