...
def apply_crt_v6(portrait_path, output_path, size=(400, 400)):
    ...
    img = ImageEnhance.Brightness(img).enhance(0.9)  # dimmer -- face readable
    ...
    # Combine: reduced bloom so face reads clearly
    bloom = b1 * 0.35 + b2 * 0.28 + b3 * 0.18 + b4 * 0.10
...
apply_crt_v6("/tmp/aether-art/austin-portrait-square.jpg",
             "/tmp/aether-art/crt_portrait_v9_large.png", size=(400, 400))
apply_crt_v6("/tmp/aether-art/austin-portrait-square.jpg",
             "/tmp/aether-art/crt_portrait_v9.png", size=(175, 175))
