...
OUTPUT_PATH = '/tmp/aether-art/dalle_render_FLAT.png'
FACE_ART = '/tmp/aether-art/dalle_face_v9.png'
...
# ============================================================
# Orthographic camera straight down -- pedal fills frame exactly
cam_z = 8.0
bpy.ops.object.camera_add(location=(0, 0, cam_z))
camera = bpy.context.active_object
camera.data.type = 'ORTHO'
camera.data.ortho_scale = 3.6  # sized to show pedal + thin desk border
