...
OUTPUT_PATH = '/tmp/aether-art/dalle_render_SHIP3.png'
...
f_tex.image = bpy.data.images.load('/tmp/aether-art/dalle-teak2/001-hyper-realistic-top-down-photograph-of-a.png')
